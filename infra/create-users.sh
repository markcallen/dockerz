#!/bin/bash
#
# Create users in the dockerz environment
#
...
echo "Running tasks/user.yml ..."
ansible-playbook -i inventory -b --private-key $AWS_SSH_KEY -e username=$USERNAME -e "key=\"$KEY\"" tasks/user.yml
